    ...
    <div className="min-h-screen bg-[#0a0b0a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border border-[#1e2220] bg-[#0d0f0d] p-6">
          <h1 className="text-[15px] font-bold text-white mb-1">First-time setup</h1>
          <p className="text-[11px] text-[#6b7068] mb-5">
            No users found. Create your admin account to continue.
          </p>
