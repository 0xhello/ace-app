  ...
  return (
    <div className="min-h-screen bg-[#07080a] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <p className="font-mono text-[9px] uppercase tracking-[0.32em] text-[#ef4444]/60 mb-5">500</p>
        ...
        <p className="text-[0.95rem] leading-relaxed text-white/36 mb-8 max-w-[34ch] mx-auto">
          A server error occurred. It's been logged and we'll look into it.
        </p>

        {error.digest && (
          <p className="font-mono text-[9px] text-white/16 mb-6">
            Ref: {error.digest}
          </p>
        )}
